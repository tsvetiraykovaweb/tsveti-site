...
CROSS JOIN (
  VALUES
    ...
    (
      'story',
      'text',
      '{"heading":"Лична история","text":"[Добавете лична история] — кратък, човешки текст без медицински твърдения и без измислени биографични детайли.","image_alt":"Визуал към историята"}',
      1
    ),
    (
      'approach',
    ...
    (
      'qualifications',
      'list',
      '{"heading":"Образование и квалификации","text":"[Добавете образование]\n[Добавете квалификация]\n[Добавете сертификат]\n[Добавете професионално наименование]","eyebrow":"Шаблон — попълнете само потвърдени данни"}',
      4
    ),
    (
      'cta',
