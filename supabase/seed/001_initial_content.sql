...
--
-- Official name: Цветелина Райкова
-- Display name: Цвети
...
INSERT INTO public.site_settings (key, value, label) VALUES
  ('official_name', to_jsonb('Цветелина Райкова'::text), 'Официално име'),
  ...
  ('primary_cta_url', to_jsonb('/bezplatna-konsultatsia'::text), 'Основен CTA линк'),
  ('social_links', '{"instagram":"","facebook":""}'::jsonb, 'Социални мрежи'),
  ('seo_title', to_jsonb('Цветелина Райкова'::text), 'SEO заглавие (по подразбиране)'),
...
CROSS JOIN (
  VALUES
    ...
    (
      'intro',
      'richtext',
      '{"html":"<p>Добре дошли. Тук ще има кратко представяне на подхода и услугите на Цветелина Райкова. Текстът е шаблон и ще бъде заменен с финално съдържание.</p>"}',
      2,
      true
    ),
    (
      'cta_banner',
      'cta',
      '{"label":"Запиши консултация","href":"/bezplatna-konsultatsia","note":"Линкът и етикетът могат да се синхронизират с site_settings."}',
      3,
      true
    )
...
INSERT INTO public.services (
  ...
  (
    ...
    1,
    'published',
    'От тревога към спокойствие · Цветелина Райкова',
  ...
  (
    ...
    2,
    'published',
    'Хранителна програма · Цветелина Райкова',
  ...
  (
    ...
    3,
    'published',
    'Избери себе си · Цветелина Райкова',
